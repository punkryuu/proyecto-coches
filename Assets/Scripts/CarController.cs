...
public class CarController : MonoBehaviour {
    ...
    float baseMaxSpeed = 50f; //velocidad m�xima que puede alcanzar el coche
    ...
    float baseAirControl = 0.25f;// redducci�n de control en el aire
    int contadorBarra;
    ...
    private void ProcessDrift(float horizontalInput)
    {
        ...
        if (driftDir == 1)
        {
            ...
            powerControl = Remap(horizontalInput, -1, 1, .2f, 1);//Cuanto mas derrapes m�s rapido carga el turbo
        }
        else
        {
